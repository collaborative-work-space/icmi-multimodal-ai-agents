#!/bin/bash
# setup_minimal.sh - Minimal setup for Examples 1-3 only
# This script sets up only what's needed for the working examples
...
echo -e "${BLUE}🚀 Langflow Tutorial Setup (Examples 1-3 Only)${NC}"
echo "=================================================="
...
echo "Installing only what's needed for Examples 1-3..."

# Core dependencies for MCP servers and custom components
...
echo -e "${GREEN}✅ requirements_minimal.txt created${NC}"
...
echo "  4. Follow the tutorials:  Tutorial_Example_1.md, 2.md, 3.md"
echo ""
